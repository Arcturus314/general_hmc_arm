...
//Pin addresses
#define speakerPin = 32 //GPIO12 on the Raspberry Pi
...
void playNote(int frequency, int time) {
  ...
  TIMER_C1 += time*1000000; //multiply by 1e6 as timer counts in us
